            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="db/mod_audit.php" method="post" id="myform">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 my-4   ">
                                        ...
                                        <input class="form-control" type="text" name="num"
                                            value="<?php echo $_GET["id"]; ?>" placeholder="Numero" id="num" required>
                                    ...
                                    <div class="col-md-9 my-2" id="">
                                        ...
                                        <select name="ser" class="form-control" onchange="getDepartements(this.value);"
                                            ...
                                            <?php
												...
												$rslt = mysqli_query($conn,"SELECT * FROM auditprevu where numero = '".$_GET["id"]."'");
                                                $oo = $rslt->fetch_assoc();
                                                $id_service = $oo["id_service"];
                                                $id_sservice = $oo["id_sservice"];
												...
												$n=$obj['id'];																	
												echo '<option value="'.$n.'"';
                                                if($n == $id_service) echo " selected";
                                                echo '>'.utf8_encode($i).'</option>';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 my-2">
                                        ...
                                        <select name="sser" id="blocDepartements" class="form-control">
                                            <?php 
                                            $sql = mysqli_query($conn,"SELECT * FROM sservice where id = $id_sservice");
                                            $obj = $sql->fetch_assoc();
                                            echo '<option valur ="'.$id_sservice.'" selected>'.$obj["nom"].'</option>';
                                            ?>
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <?php																	
                                                ...
                                                $res = mysqli_query($conn,$req1);								
                                                    while  ($obj = $res->fetch_assoc()) 
                                                    {
                                                        ...
                                                        if($n == $_GET["ra"]) echo " selected";
                                                        
                                                        echo '>'.utf8_encode($i).' '.utf8_encode($j).'</option>';   
                                                    } 
                                          ?>
                                        </select>
                                    </div>
